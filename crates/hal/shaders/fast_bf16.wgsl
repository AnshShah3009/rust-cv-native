...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    let p = get_u32(x, y);
    let high = p + u32(params.threshold);
    let low = p - u32(params.threshold);

    let v0 = get_u32(x, y - 3);
    let v1 = get_u32(x + 1, y - 3);
    let v2 = get_u32(x + 2, y - 2);
    let v3 = get_u32(x + 3, y - 1);
    let v4 = get_u32(x + 3, y);
    let v5 = get_u32(x + 3, y + 1);
    let v6 = get_u32(x + 2, y + 2);
    let v7 = get_u32(x + 1, y + 3);
    let v8 = get_u32(x, y + 3);
    let v9 = get_u32(x - 1, y + 3);
    let v10 = get_u32(x - 2, y + 2);
    let v11 = get_u32(x - 3, y + 1);
    let v12 = get_u32(x - 3, y);
    let v13 = get_u32(x - 3, y - 1);
    let v14 = get_u32(x - 2, y - 2);
    let v15 = get_u32(x - 1, y - 3);
