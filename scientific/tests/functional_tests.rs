...
fn test_vectorized_iou_and_polygon_iou() {
    ...
    use geo::Polygon;
    use geo::LineString;
    let p1 = Polygon::new(LineString::from(vec![(0.0, 0.0), (10.0, 0.0), (10.0, 10.0), (0.0, 10.0), (0.0, 0.0)]), vec![]);
    let p2 = Polygon::new(LineString::from(vec![(5.0, 5.0), (15.0, 5.0), (15.0, 15.0), (5.0, 15.0), (5.0, 5.0)]), vec![]);
