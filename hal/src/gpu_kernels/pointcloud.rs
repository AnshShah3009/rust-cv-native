...
pub fn transform_points(
    ...
    if num_points == 0 { return Ok(input.clone()); }
    ...
    let num_points_buffer = ctx.device.create_buffer_init(&wgpu::util::BufferInitDescriptor {
...
pub fn compute_normals(
    ...
    if num_points == 0 { return Ok(points.clone()); }
